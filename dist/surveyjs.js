...
/* harmony import */ var _modules_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helpers.js");
/* harmony import */ var _modules_messages__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/messages.js");
/* harmony import */ var _modules_options__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/options.js");
/* harmony import */ var _modules_constructor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/modules/constructor.js");
/* harmony import */ var _modules_retrieveSurvey__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/modules/retrieveSurvey.js");
/* harmony import */ var _modules_destroy__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/modules/destroy.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildSurvey", function() { return buildSurvey; });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helpers.js");
/* harmony import */ var _generateQAcode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/buildSurvey/generateQAcode.js");
/* harmony import */ var _populateAnswers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/buildSurvey/populateAnswers.js");
...
function buildSurvey() {
  var self = this,
      ...
      surveyContEl = formEl.closest('[data-surveyjs-container]'); // REPLACE SURVEY ID AND FORM NAME IN LOCALSTORAGE NAME

  self.internals.localStorageName = self.internals.localStorageName.replace(/{{surveyId}}/g, data.id);
  self.internals.localStorageName = self.internals.localStorageName.replace(/{{surveyFormName}}/g, formName); // PRINT GENERAL SURVEY DATA: TITLE AND DESCRIPTION
  ...
  var qaHtmlAll = _generateQAcode__WEBPACK_IMPORTED_MODULE_1__["generateQAcode"].call(self, data.questions); // PRINT ALL QUESTIONS & ANSWERS

  Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["appendDomStringToNode"])(qaHtmlAll, formEl.querySelector('[data-surveyjs-body]')); // FILL ANSWERS WITH LOCAL STORAGE ( IF AVAILABLE )

  _populateAnswers__WEBPACK_IMPORTED_MODULE_2__["populateAnswers"].call(self); // INIT FIELDS VALIDATION
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateQAcode", function() { return generateQAcode; });
/* harmony import */ var _generateQAcodeUtils_iterateAnswers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/buildSurvey/generateQAcodeUtils/iterateAnswers.js");
...
function generateQAcode() {
  ...
  for (var i = 0; i < qaDataLength; i++) {
    var item = qaData[i],
        ...
        aHtml = '',
        qaHtml = self.options.templates.question; // HTML CODE FOR THE ANSWER/S
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/attribute.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "attribute", function() { return attribute; });
/* harmony import */ var _generateOptionTags__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/generateOptionTags.js");
 // RELATED ANSWER
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/generateOptionTags.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateOptionTags", function() { return generateOptionTags; });
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/input.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/nested.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/select.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/textarea.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/generateFieldHTML.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateFieldHTML", function() { return generateFieldHTML; });
/* harmony import */ var _fieldsHTML_attribute__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/attribute.js");
/* harmony import */ var _fieldsHTML_input__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/input.js");
/* harmony import */ var _fieldsHTML_nested__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/nested.js");
/* harmony import */ var _fieldsHTML_select__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/select.js");
/* harmony import */ var _fieldsHTML_textarea__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/modules/buildSurvey/generateQAcodeUtils/fieldsHTML/textarea.js");
...
/***/ "./src/modules/buildSurvey/generateQAcodeUtils/iterateAnswers.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function iterateAnswers(obj, qID, qIdx, attrReq) {
  var self = this;
  var progIds = self.internals.progIds; // obj          MUST BE AN ARRAY OF STRINGS OR AN OBJECT THAT CONTAINS 'answers' AS ARRAY (THE FUNCTION iterateAnswers LOOPS UNTIL A STRING IS FOUND, AND PRINTS IT)
  ...
  var _loop = function _loop(_a) {
    ...
    if (needsBinding) {
      var boundedFieldEl = self.formEl.closest('[data-surveyjs-container]').querySelectorAll('[data-name="bind-surveyjs-answer"]')[_a],
          fieldProps = {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "populateAnswers", function() { return populateAnswers; });
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helpers.js");
/* harmony import */ var _internals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/internals.js");
/* harmony import */ var _listenerCallbacks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/listenerCallbacks.js");
...
function constructorFn(formEl) {
  ...
  var self = this,
      ...
      checkFormElem = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["checkFormEl"])(formEl);
  ...
  formEl = self.formEl; // SET THE lang VALUE IN options ( MANDATORY FOR OTHER OPERATIONS )
  ...
  self.options = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["mergeObjects"])({}, self.options, self.messages[self.options.lang]); // MERGE OPTIONS
  ...
  self.options.templates.labelTag = self.options.templates.labelTag.replace(/{{labelClass}}/g, self.options.cssClasses.label); // SET INTERNAL UTILS
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fieldsStringSelectorSurvey", function() { return fieldsStringSelectorSurvey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ajaxCall", function() { return ajaxCall; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "appendDomStringToNode", function() { return appendDomStringToNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkFormEl", function() { return checkFormEl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "concatFieldsLists", function() { return concatFieldsLists; });
...
/* harmony import */ var _webStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/webStorage.js");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helpers.js");
/* harmony import */ var _utils_getAnswerIndexInLocalStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/utils/getAnswerIndexInLocalStorage.js");
/* harmony import */ var _utils_getQuestionObject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/utils/getQuestionObject.js");
...
var callbackFns = {
  ...
  validation: function validation(event) {
    var self = this,
        ...
        reqMoreEl = isRequiredFrom ? containerEl.querySelector(fieldEl.getAttribute('data-required-from')) : null; // VARS USED TO VALIDATE THE FILED IF IT IS REQUIRED

    var itemEl = isRequiredFrom ? reqMoreEl : fieldEl,
        questionId = itemEl.id ? itemEl.id.split('-')[1] : 'id-not-found',
        isFieldForChangeEventBoolean = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["isFieldForChangeEvent"])(fieldEl),
        questionObj = _utils_getQuestionObject__WEBPACK_IMPORTED_MODULE_2__["getQuestionObject"].call(self, questionId); // IF IT'S NOT A SURVEY QUESTION -> SKIP
    ...
    if (isFieldForChangeEventBoolean && eventName === 'change' || !isFieldForChangeEventBoolean && eventName !== 'change') {
      ...
      if (self.options.useLocalStorage && !fieldEl.matches('[data-exclude-storage]')) {
        var inArrayPos = _utils_getAnswerIndexInLocalStorage__WEBPACK_IMPORTED_MODULE_1__["getAnswerIndexInLocalStorage"].call(self, fieldEl.name, isMultiChoice ? fieldValue : false),
            inArrayRequireMorePos = _utils_getAnswerIndexInLocalStorage__WEBPACK_IMPORTED_MODULE_1__["getAnswerIndexInLocalStorage"].call(self, fieldEl.name + '-more');
...
/* harmony import */ var _optionsUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/optionsUtils.js");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helpers.js");
/* harmony import */ var _utils_getQuestionObject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/utils/getQuestionObject.js");
    ...
    beforeSend: function beforeSend_surveyDefault(data) {
      ...
      fieldsList.forEach(function (fieldEl) {
        var type = fieldEl.type,
            name = fieldEl.name; // IF A FIELD HAS THE SAME NAME ATTRIBUTE AND IT IS OF THE SAME TYPE
        ...
        var questionObj = _utils_getQuestionObject__WEBPACK_IMPORTED_MODULE_1__["getQuestionObject"].call(surveyjs, questionId); // BASED ON SURVEY JSON FILE, FORCE REQUIRED FIELDS TO BE VALIDATED
...
/***/ "./src/modules/retrieveSurvey.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "retrieveSurvey", function() { return retrieveSurvey; });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helpers.js");
/* harmony import */ var _buildSurvey_buildSurvey__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/buildSurvey/buildSurvey.js");
...
/***/ "./src/modules/utils/getAnswerIndexInLocalStorage.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAnswerIndexInLocalStorage", function() { return getAnswerIndexInLocalStorage; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getQuestionObject", function() { return getQuestionObject; });
