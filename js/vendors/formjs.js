...
/* harmony import */ var _modules_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _modules_options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/options.js");
/* harmony import */ var _modules_validationRules__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/validationRules.js");
/* harmony import */ var _modules_validationErrors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/modules/validationErrors.js");
/* harmony import */ var _modules_constructor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/modules/constructor.js");
/* harmony import */ var _modules_destroy__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/modules/destroy.js");
/* harmony import */ var _modules_getFormData__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/modules/getFormData.js");
/* harmony import */ var _modules_init__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./src/modules/init.js");
/* harmony import */ var _modules_validateField__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./src/modules/validateField.js");
/* harmony import */ var _modules_validateForm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./src/modules/validateForm.js");
...
/***/ "./src/modules/ajaxCall.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ajaxCall", function() { return ajaxCall; });
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
...
function ajaxCall(formDataObj) {
  var self = this,
      ...
      timeoutTimer,
      ajaxOptions = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["mergeObjects"])({}, formOptions.ajaxOptions),
      isMultipart = ajaxOptions.headers['Content-Type'] === 'multipart/form-data';
  ajaxOptions.body = formDataObj; // POST A FormData OBJECT ( multipart )
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _listenerCallbacks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/listenerCallbacks.js");
/* harmony import */ var _formStartup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/formStartup.js");
...
function constructorFn(formEl) {
  ...
  var self = this,
      ...
      checkFormElem = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["checkFormEl"])(formEl);
...
var init = function init() {
  var self = this,
      formEl = self.formEl,
      formFields = formEl.querySelectorAll(_helper__WEBPACK_IMPORTED_MODULE_0__["fieldsStringSelector"]);
  ...
  Array.from(formFields).forEach(function (fieldEl) {
    ...
    var isCheckboxOrRadio = fieldEl.type === 'checkbox' || fieldEl.type === 'radio',
        isFieldForChangeEventBoolean = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["isFieldForChangeEvent"])(fieldEl),
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _validationRules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/validationRules.js");


function isValid(fieldEl) {
  var fieldOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var self = this,
      fieldType = fieldEl.matches('[data-subtype]') ? Object(_helper__WEBPACK_IMPORTED_MODULE_0__["toCamelCase"])(fieldEl.getAttribute('data-subtype')) : fieldEl.type,
  ...
  fieldAttributes.forEach(function (attr) {
    ...
    var attrName = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["toCamelCase"])(attr.name.replace('data-', '')),
        attrValue = attr.value,
        isAttrValueWithFn = attrName === 'type' && typeof _validationRules__WEBPACK_IMPORTED_MODULE_1__["validationRulesAttributes"][attrValue] === 'function',
        isAttrNameWithFn = typeof _validationRules__WEBPACK_IMPORTED_MODULE_1__["validationRulesAttributes"][attrName] === 'function';
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _checkDirtyField__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/checkDirtyField.js");
/* harmony import */ var _isValid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/modules/isValid.js");
...
function isValidField(fieldElem) {
  ...
  var options = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["mergeObjects"])({}, self.options.fieldOptions, fieldOptionsObj),
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _isValidField__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/isValidField.js");
...
function isValidForm() {
  ...
  var self = this,
      formEl = self.formEl,
      obj = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["mergeObjects"])({}, _helper__WEBPACK_IMPORTED_MODULE_0__["validateFormObjDefault"]),
      fieldOptions = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["mergeObjects"])({}, fieldOptionsObj, {
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _submit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/submit.js");
...
var callbackFns = {
  ...
  validation: function validation(event) {
    ...
    if (fieldEl.matches(_helper__WEBPACK_IMPORTED_MODULE_0__["fieldsStringSelector"])) {
      var isFieldForChangeEventBoolean = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["isFieldForChangeEvent"])(fieldEl),
...
/* harmony import */ var _optionsAjax__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/optionsAjax.js");
...
var defaultCallbacksInOptions = {
  fieldOptions: {
    onValidation: function onValidationDefault(fieldsArray) {
      ...
      var self = this,
          options = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["mergeObjects"])({}, self.options.fieldOptions, tempOptions.fieldOptions);
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _ajaxCall__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/ajaxCall.js");
...
function submit(event) {
  ...
  var handleValidation = options.fieldOptions.handleValidation,
      formValidationPromise = handleValidation ? self.validateForm() : Promise.resolve(_helper__WEBPACK_IMPORTED_MODULE_0__["validateFormObjDefault"]);
...
function validateField(fieldElem) {
  ...
  var self = this,
      fieldEl = typeof fieldElem === 'string' ? self.formEl.querySelector(fieldElem) : fieldElem,
      fieldOptions = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["mergeObjects"])({}, self.options.fieldOptions, fieldOptionsObj);
  return new Promise(function (resolve) {
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/modules/helper.js");
/* harmony import */ var _isValidForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/modules/isValidForm.js");
